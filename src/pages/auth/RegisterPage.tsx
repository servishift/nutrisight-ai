        ...
        >
          ...
          {registrationClosed && (
            <div className="mb-4 rounded-lg border border-amber-500/20 bg-amber-500/5 p-4 text-center">
              <p className="text-sm font-medium text-foreground mb-1">Registration Temporarily Closed</p>
              <p className="text-xs text-muted-foreground">New registrations are currently disabled. Please check back later.</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <fieldset disabled={registrationClosed}>
            ...
            <Button type="submit" className="w-full" disabled={loading || registrationClosed}>
